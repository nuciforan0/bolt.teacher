        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-3">
            <div className="flex gap-2">
              <a
                href="/"
                className="flex-1 flex gap-2 items-center bg-[#e0fafa] dark:bg-[#129e9d22] text-[#15b6b4] dark:text-[#15b6b4] hover:bg-[#b3f0f0] dark:hover:bg-[#129e9d33] rounded-lg px-4 py-2 transition-colors"
              >
              ...
              <button
                ...
                className={classNames(
                  ...
                  selectionMode
                    ? 'bg-[#15b6b4] dark:bg-[#129e9d] text-white border border-[#129e9d] dark:border-[#15b6b4]'
            ...
            <div className="relative w-full">
              ...
              <input
                className="w-full bg-gray-50 dark:bg-gray-900 relative pl-9 pr-3 py-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#15b6b4] text-sm text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-500 border border-gray-200 dark:border-gray-800"
                type="search"
